...
from config import API_ID, API_HASH, BOT_TOKEN, API_KEY, SERVER_NAME
...
base_url = f"https://{SERVER_NAME}/api/v2.0/indexers/all/results/torznab/api?apikey={API_KEY}&q="
